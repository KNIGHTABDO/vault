...
export function ChatInterface({ conversationId }: { conversationId: string | null }) {
  ...
  const [selectedModel, setSelectedModel] = useState<"vault" | "spark">("vault");
