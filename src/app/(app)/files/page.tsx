  ...
  return (
    <div className="flex items-center justify-center h-full">
      <div className="text-center max-w-md p-8">
        ...
        <h2 className="font-display text-xl text-vault-200 mb-2">Files</h2>
        <p className="text-sm text-vault-400">Manage files the AI can access. Upload, organize, and share files with your conversations.</p>
