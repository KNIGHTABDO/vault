  ...
  return (
    <div className="min-h-screen bg-vault-bg flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        {/* Error */}
        {error && (
          <div className="mb-4 p-3 rounded-xl bg-vault-error/10 border border-vault-error/20 text-xs text-vault-error">
        ...
        <form action={signUp} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 rounded-xl bg-vault-surface border border-vault-border-subtle text-sm text-vault-text placeholder:text-vault-text-ghost outline-none focus:border-vault-border-hover transition-colors"
            />
            <p className="text-2xs text-vault-text-ghost mt-1.5">
        ...
        <p className="text-2xs text-vault-text-ghost text-center mt-4">
          By creating an account, you agree to our{" "}
          <Link href="/terms" className="text-vault-text-tertiary hover:text-vault-accent transition-colors">
            Terms
          </Link>{" "}
          and{" "}
          <Link href="/privacy" className="text-vault-text-tertiary hover:text-vault-accent transition-colors">
            Privacy Policy
          </Link>
          .
        </p>
        ...
        <form action={signInWithGitHub}>
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-xl bg-vault-surface border border-vault-border-subtle hover:border-vault-border text-sm text-vault-text-secondary hover:text-vault-text transition-all duration-150"
          >
